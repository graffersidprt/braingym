...
import { compareDates, formatUpdateFilterDate, showInvalidDateMessge } from "../../constants/utils";
import {
  defaultGenderState,
...
const BrainHealthSummaryDetailFilter: React.FC<Props> = (props: Props) => {
  ...
  const handleFilterClick = () => {
    ...
    const params = {
      filterType: 1,
      startDate: filterStartDate ? formatUpdateFilterDate(filterStartDate) : "",
      endDate: filterEndDate ? formatUpdateFilterDate(filterEndDate) : "",
      day: "",
      week: "",
      month: "",
      year: "",
...
export default BrainHealthSummaryDetailFilter;
